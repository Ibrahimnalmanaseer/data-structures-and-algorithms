...
const addValues = (arr) => {
  ...
  let sum=arr.reduce( (accumulator,value)=> accumulator=accumulator+value ,0)
  return sum;
...
const addPurchases = (arr) => {
  ...
  let total=0;
  arr.reduce((accumulator,value,)=>total= total+ value.purchasePrice ,0)
...
const countNumberOfElements = (arr) => {
  ...
  let arrLength=arr.reduce((accumulator,value)=> accumulator + 1,0);
...
const returnNames = (arr) => {
  return(arr.reduce((accumulator,value,indx)=> accumulator[indx]=[value.name],[]));
