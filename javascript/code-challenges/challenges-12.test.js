...
Write a function named hasNumber that uses a regular expression pattern to determine if a 
string has one or more letter followed by one or more digit.
...
const hasNumber = (string) => {
  ...
  const pattern_2=/[0-9]/;
  return pattern_1.test(string) ? pattern_2.test(string) : false;
...
const validateEmail = (email) => {
  ...
  const pattern= /^[a-zA-Z0-9]+.?[a-zA-Z0-9]+@[a-zA-Z0-9]+.(org|net|com)$/g;
